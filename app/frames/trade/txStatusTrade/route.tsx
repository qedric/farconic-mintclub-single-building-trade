...
const handleRequest = frames(async (ctx) => {
    ...
    if (txId) {
        ...
        if (receipt.status == 'success') {
            ...
            const targetUrl = `https://warpcast.com/~/compose?text=${encodeURIComponent(shareText)}%0Ahttps://farconic-mintclub-building-trade.vercel.app?buildingName=${building.metadata.name.replace(/ /g, '+')}`
